    ...
    <tr :key="item.id">
        ...
        <td>
         <div class="d-flex ga-2 justify-start">
            <v-icon :color="favoriteColor" icon="mdi-heart" size="small" @click="props.favorite"></v-icon>
            <v-icon color="medium-emphasis" icon="mdi-dots-horizontal" size="small" @click="props.onHandleMore"></v-icon>
        </div>
        </td>
